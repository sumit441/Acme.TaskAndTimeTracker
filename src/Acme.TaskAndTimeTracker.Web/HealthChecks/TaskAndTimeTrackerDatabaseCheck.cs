...
public class TaskAndTimeTrackerDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public TaskAndTimeTrackerDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
