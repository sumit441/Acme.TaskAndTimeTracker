...
public static class TaskAndTimeTrackerEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE TaskAndTimeTrackerModuleExtensionConfigurator CLASS (in the Domain.Shared project)
